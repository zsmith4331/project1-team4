   ...
   function geosearch() {
    ...
    "&query=" + cityName;
      ...
      $.ajax({
         ...
         var ZomatoQueryURL = "https://developers.zomato.com/api/v2.1/geocode?lat=" + lat + "&lon=" + long;
         ...
         headers: {
            ...
            var rest1Rating = response.nearby_restaurants[0].restaurant.user_rating.rating_text;
            ...
            var rest2Rating = response.nearby_restaurants[1].restaurant.user_rating.rating_text;
            ...
            var rest3Rating = response.nearby_restaurants[2].restaurant.user_rating.rating_text;
